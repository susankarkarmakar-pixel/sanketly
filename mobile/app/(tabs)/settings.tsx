...
export default function SettingsScreen() {
  ...
  return <ScreenContainer edges={["top", "left", "right", "bottom"]}><ScrollView contentContainerStyle={styles.content}>
    ...
    <SsaButton label={language === "bn" ? "প্রথম setup ও readiness wizard" : language === "hi" ? "First-run readiness wizard" : "First-run readiness wizard"} variant="secondary" onPress={() => router.push("/readiness")} />
    <SsaButton label={language === "bn" ? "ফিচার পরীক্ষা কেন্দ্র" : language === "hi" ? "फ़ीचर परीक्षण केंद्र" : "Feature Test Center"} variant="secondary" onPress={() => router.push("/test-center")} />
